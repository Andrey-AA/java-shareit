...
public class BookingController {
    ...
    @PostMapping
    public BookingShort createBooking(@RequestBody BookingFromDomain bookingFromDomain,
    ...
    public List<BookingShort> findBookingsByOwner(
            ...
            @RequestParam(name = "size", defaultValue = "20") Integer size) {
       BookingState.checkState(state);
       return bookingService.findBookingsByOwner(requesterId, state, from, size);
    }
}
